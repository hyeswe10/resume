        ...
        <div id='main-info'>
            ...
            <div className='right'>
                <div className='about-me'>
                    <h3>ABOUT ME</h3>
                    <p>새로운 기술을 빠르게 익히고 끝까지 파고드는 신입 프론트엔드 개발자입니다. React 기반 프로젝트로 기본기를 다져왔고, 지금은 다룰 수 있는 도구의 폭을 넓히기 위해 Vue와 TypeScript를 공부하고 있습니다. 변화하는 기술 흐름에 맞춰 스스로를 발전시킴벼, 팀이 믿고 맡길 수 있는 사람이 되고자 합니다.</p>
                </div>
                <div className='team'>
                    <h3>TEAM PROJECTS</h3>
                    <div className='desc'>
